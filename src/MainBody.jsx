            ...
            <section id="how-it-works" className="how-it-works-section">
                ...
                <div className="tiles">
                    <article className="tile">
                        ...
                        <p>
                            Call us and book in a "Design Consultation" on a
                    ...
                    <article className="tile">
                        ...
                        <p>
                            We come to your home to do an assessment of the
                            space and to your style preference.
                        </p>
                    </article>
                    <article className="tile">
                        <img
                        ...
                        <h3>We recommend...</h3>
                        <p>
                            We send you a bespoke set of fireplace
                            recommendations.
                        </p>
                    </article>
                </div>
